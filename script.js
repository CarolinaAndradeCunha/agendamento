...
listaSubservicos.addEventListener('click', (e) => {
  ...
  if (el) {
    ...
    // Verifica se já foi adicionado (evita duplicata)
...
botaoAgendar.addEventListener('click', (e) => {
  ...
  if (servicosEscolhidos.length === 0) {
    alert('Selecione pelo menos um serviço antes de agendar.');
    return;
  }
  ...
  window.location.href = 'agendamento.html'; // Ajuste para o nome correto do seu arquivo
});
